...
public class ThreadController {
    ...
    public Result save(@RequestBody Thread thread) {
        ...
        return new Result(flag ? Code.SAVE_OK : Code.SAVE_ERR, flag, flag ?"文章創建成功":"文章創建失敗");
    }
    //查詢所有文章
    @GetMapping
    @ApiOperation("查詢所有文章")
    ...
    public Result updateById(@RequestBody Thread thread) {
        ...
        return new Result(flag ? Code.UPDATE_OK : Code.UPDATE_ERR, flag, flag ?"文章更新成功":"文章更新失敗");
    }
    //刪除文章
    @DeleteMapping("/{id}")
    @ApiOperation("刪除文章")
    public Result deleteById(@PathVariable Integer id) {
        ...
        return new Result(flag ? Code.DELETE_OK : Code.DELETE_ERR, flag, flag ?"文章刪除成功":"文章刪除失敗");
    }
}
